#!/usr/bin/env bash
# Run the Safe DDS edge integration test on a QNX VM.
set -euo pipefail
...
# Generated by scripts/launch_tpi_2_2_test.sh
[perms=555] bin/safe_edge_edge_gateway=${EDGE_BIN_DIR}/safe_edge_edge_gateway
[perms=555] bin/test_edge_integration=${EDGE_BIN_DIR}/test_edge_integration
EOF
}
