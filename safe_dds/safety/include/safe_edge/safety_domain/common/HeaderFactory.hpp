#ifndef SAFE_EDGE_SAFETY_DOMAIN_COMMON_HEADERFACTORY_HPP
#define SAFE_EDGE_SAFETY_DOMAIN_COMMON_HEADERFACTORY_HPP
...
#endif // SAFE_EDGE_SAFETY_DOMAIN_COMMON_HEADERFACTORY_HPP
